...
import { styles } from '../styles/pages/LanguageAccessibility.styles';
          ...
          <View style={styles.fieldGroup}>
            ...
            <View style={[styles.pickerContainer, { backgroundColor: colors.card, borderColor: colors.border }]}>
              <Picker selectedValue={fontType} onValueChange={(v) => setFontType(v)} style={{ color: colors.text }} dropdownIconColor={colors.text}>
                <Picker.Item label="Par défaut" value="default" /><Picker.Item label="OpenDyslexic" value="opendyslexic" />
              </Picker>
            </View>
          </View>
        </View>
